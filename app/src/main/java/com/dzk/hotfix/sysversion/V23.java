...
//        File pathchFile = new File("/sdcard/patch.dex");
        ...
        try {
            ...
            Method makeDexElementsMethod = ShareReflectUtils.findMethod(dexPathList,"makePathElements",
                    List.class,File.class,List.class);
            List<File> fileList = new ArrayList<>();
            fileList.add(file);
            final List<IOException> suppressedExceptionList = new ArrayList<IOException>();
            Object[] fixElements = (Object[]) makeDexElementsMethod.invoke(null, fileList, context.getCacheDir(), suppressedExceptionList);
